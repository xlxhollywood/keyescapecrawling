...
public class GoldenkeyCrawling {
    ...
    static {
        ...
        GOLDEN_KEY_THEME_INFO.add(new ThemeInfo(281, "황금열쇠", "강남", "강남 플라워로드점", "Back화점"));
        ...
        GOLDEN_KEY_THEME_INFO.add(new ThemeInfo(296, "황금열쇠", "강남", "강남 플라워로드점", "ANOTHER"));
        GOLDEN_KEY_THEME_INFO.add(new ThemeInfo(297, "황금열쇠", "강남", "강남 타임스퀘어점", "NOMON : THE ORDEAL"));
